...
const Save = module.exports = function Save (options, db) {
  ...
  recordDataPoints: function () {
    ...
    return _.map(_.keys(that.options.assets), function (asset) {
      return new Promise(function (resolve, reject) {
        ...
        switch (assetType) {
          case 'js':
            const assetToParse = Array.isArray(that.options.assets[asset]) ? that.options.assets[asset] : [that.options.assets[asset]]
